const en = {
  message: {
    ...
    new_group: 'New Folder',
    new_group_prompt: 'Folder Name',
    rename_group: 'Rename Folder',
    del_group: 'Delete Folder',
    confirm_delete_group: 'Delete this folder? Connections inside will move back to the root level.',
    move_to_group: 'Move to Folder',
    ungroup_connection: 'Remove from Folder',
    ...
    test_connection_failed: 'Connection failed: {msg}',
